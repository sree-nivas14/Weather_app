...
function App() {
  ...
  return (
    <div className="App">
      <div
        class="container col-md-8 alert alert-primary alert-dismissible fade show text-center"
        role="alert"
        style={{ display: "none" }}
      >
      ...
      <>
        <div className="container col-sm-12 col-md-6  card">
          ...
          >
            ...
            <div className="d-flex justify-content-center align-items-end temp_data">
